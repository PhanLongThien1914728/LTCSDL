...
namespace RestaurantManagementProject
{
    public partial class frmFood : Form
    {
        ...
        public void LoadFoodDataToListView()
        {
            ...
            {
                ListViewItem item = lvsFood.Items.Add(count.ToString());
        ...
        private void lvsFood_SelectedIndexChanged(object sender, EventArgs e)
        {
            for (int i = 0; i < lvsFood.Items.Count; i++)
            {
                if (lvsFood.Items[i].Selected)
                {
